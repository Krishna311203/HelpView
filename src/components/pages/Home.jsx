  ...
  return (
    <>
      ...
      >
        {/* innovation div */}
        <div
          className=" p-3 sm:p-10 lg:mx-20 xl:mx-40  lg:pt-14  flex flex-col text-gray-800 sm:max-w-[500px] lg:max-w-[650px] 
      md:max-w-[600px]  items-start justify-start"
        >
          ...
          <p className="flex text-[18px] leading-6">
            {" "}
            Don't let nerves hold you back. Prepare effectively with our
            interactive interview simulator, tailored questions, and expert
            guidance.
          </p>
          <img
          ...
          <div className=" w-full flex items-center justify-center">
            <button
              ...
              className="flex text-gray-800 items-center  justify-center home-hero-know-btn font-bold text-[24px] px-5 py-2 md:px-8 md:py-4 lg:px-14 "
            >
              Know More
            </button>
          </div>
      ...
      <section data-aos="fade-up" className=" px-3 md:px-10 lg:px-28 xl:px-36">
        ...
        <div className="flex flex-col items-center justify-center mt-10 md:mt-16 lg:my-14">
          <h2 className="text-[24px] font-bold md:text-[36px] leading-[43px] text-center">
           Never Lack Preparation
          </h2>
          <p className="text-center text-[18px] md:text-[24px] leading-[32px] mt-5 md:mt-10 lg:mt-14 ">
            Embark on a journey of self-expression, where your words flow
            smoothly and your message resonates. With our innovative speech
            improvement tools and exercises, you can overcome challenges and
              ...
              <div className=" relative rounded-[8px] home-sol-outter-card-1-eff   w-[321px] h-[238px] lg:w-[261px] lg:h-[238px] text-white">
                ...
                <div className="absolute rounded-[8px] px-3   home-sol-card-1 w-full h-full bottom-0 flex flex-col items-start justify-center gap-2">
                  ...
                  <p className="text-[16px]">
                    Enhance your speech precision with targeted articulation
                    exercise.{" "}
                  </p>
            ...
            <Link to="/breathing-exercise">
              ...
              <div className=" relative rounded-[8px] home-sol-outter-card-1-eff   w-[321px] h-[238px] lg:w-[261px] lg:h-[238px] text-white">
                ...
                <div className="absolute rounded-[8px] px-3   home-sol-card-1 w-full h-full bottom-0 flex flex-col items-start justify-center gap-2">
                  ...
                  <p className="text-[16px]">
                    Unlock the power of clear speech with focused breathing
                    exercise.{" "}
                  </p>
                  <p className="text-[16px] ">Try it..</p>
                </div>
            ...
            <Link to="/regular-meet">
              <div className=" relative rounded-[8px] home-sol-outter-card-1-eff   w-[321px] h-[238px] lg:w-[261px] lg:h-[238px] text-white">
                ...
                <div className="absolute rounded-[8px] px-3   home-sol-card-1 w-full h-full bottom-0 flex flex-col items-start justify-center gap-2">
                  ...
                  <p className="text-[16px]">
                    Join our regular meet and connect with a supportive
                    community.{" "}
                  </p>
                  <p className="text-[16px] ">Try it..</p>
                </div>
            ...
            <Link to="/tongue-twister">
              ...
              <div className=" relative rounded-[8px] home-sol-outter-card-1-eff   w-[321px] h-[238px] lg:w-[261px] lg:h-[238px] text-white">
                ...
                <div className="absolute rounded-[8px] px-3   home-sol-card-1 w-full h-full bottom-0 flex flex-col items-start justify-center gap-2">
                  ...
                  <p className="text-[16px]">
                    Master pronunciation with challenging tongue twisters
                    exercise.{" "}
                  </p>
                  <p className="text-[16px] ">Try it..</p>
                </div>
        ...
        <div className="flex flex-col items-center justify-center my-20 md:my-14 lg:my-20">
          ...
          >
            <img
              className="md:w-[336px] lg:w-[400px] xl:w-[350px] rounded-[100%]"
              src={homeRecoDate}
              alt=""
            />
            ...
            <div className=" flex flex-col items-center justify-center text-center md:text-start md:items-start md:justify-start lg:w-[46%]">
              ...
              <p className="text-[#7D7987] text-[18px] leading-[30px]">
                {" "}
                Fluent speech is the cornerstone of effective communication.
                Whether in personal relationships, professional settings, or
                public speaking, clear and confident expression is vital.
              </p>
              <p className="text-[#7D7987] text-[18px] leading-[30px] my-2">
                Fluent Speech equips you with the skills to convey your thoughts
                with precision and confidence, ensuring your message is heard
                and understood{" "}
              </p>
              {/* <p className='text-[#7D7987] text-[18px] leading-[30px]'>
          ...
          >
            ...
            <div className=" flex flex-col items-center justify-center text-center md:text-start md:items-start md:justify-start lg:w-[46%]">
              ...
              <p className="text-[#7D7987] text-[18px] leading-[30px]">
                {" "}
                Stammering or speech challenges can erode self-confidence.
                Fluent Speech exists to restore that confidence by providing the
                tools and support you need to overcome speech impediments.
              </p>
              <p className="text-[#7D7987] text-[18px] leading-[30px] my-2">
                We believe that everyone deserves the opportunity to express
                themselves boldly and without reservation.{" "}
              </p>
              {/* <p className='text-[#7D7987] text-[18px] leading-[30px]'>
          ...
          >
            ...
            <div className=" flex flex-col items-center justify-center text-center md:text-start md:items-start md:justify-start lg:w-[46%]">
              ...
              <p className="text-[#7D7987] text-[18px] leading-[30px]">
                {" "}
                In today's competitive world, strong communication skills are
                paramount. Fluent speech opens doors to career opportunities and
                personal growth
              </p>
              <p className="text-[#7D7987] text-[18px] leading-[30px] my-2">
                With Fluent Speech, you'll gain the edge you need to excel in
                interviews, presentations, and everyday interactions, unlocking
 ...
 <Slider className='slider-outter  w-[85vw] ' {...settings}>
     {
      ...
      <div
        data-aos="fade-up"
        className="flex flex-col items-center justify-center  mt-[90px]"
      >
        ...
        <div className="  flex relative items-center justify-center py-10 md:py-2  md:w-[55vw]">
          ...
          <p className="text-[18px] text-center w-[90vw]  md:w-[50vw] p-3 md:p-5">
            As someone who struggled with stammering for years, I can't express
            how incredibly helpful this platform has been. The articulation
            exercises are not only effective but also enjoyable to practice. The
            platform's user-friendly approach have made a world of difference. I
            highly recommend Fluent Speech to anyone seeking to improve their
            speech and gain confidence. It's been a life-changing experience for
            me, and I couldn't be more grateful for this wonderful platform.
          </p>
          <img
